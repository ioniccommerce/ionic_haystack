...
Present all of results as a list of products, always including the name of the product with the provided link to purchase. 
Other provided information can be included as relevant to the request, including price, merchant name, etc.
"""
    )
)
